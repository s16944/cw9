    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            Console.WriteLine($"{GetCurrentMethodName()}: {string.Join(", ", res2)}");
        }

        private static string GetCurrentMethodName() => new StackTrace().GetFrame(1)?.GetMethod()?.Name;
        ...
        public void Przyklad2()
        {
            ...
            Console.WriteLine($"{GetCurrentMethodName()}: {string.Join(", ", res)}");
        }
        ...
        public void Przyklad3()
        {
            ...
            Console.WriteLine($"{GetCurrentMethodName()}: {res}");
        }
        ...
        public void Przyklad4()
        {
            ...
            var res = Emps.Where(emp => emp.Salary == maxSalary);
            Console.WriteLine($"{GetCurrentMethodName()}: {string.Join(", ", res)}");
        }
        ...
        public void Przyklad7()
        {
            var res = Emps
                .GroupBy(emp => emp.Job)
                .Select(empGroup => new {Praca = empGroup.Key, LiczbaPracownikow = empGroup.Count()});
            Console.WriteLine($"{GetCurrentMethodName()}: {string.Join(", ", res)}");
        }
        ...
        public void Przyklad9()
        {
            var res = Emps
                ...
                .FirstOrDefault(emp => emp.Job == "Frontend programmer");
            Console.WriteLine($"{GetCurrentMethodName()}: {string.Join(", ", res)}");
        }
